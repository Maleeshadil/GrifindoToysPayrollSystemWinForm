...
{
    public partial class SetSalaryMonth : Form
    {
        ...
        private void SetSalaryMonth_Paint(object sender, PaintEventArgs e)
        {
            //-> SMOOTH OUTER BORDER
        ...
        private void SetSalaryMonth_ResizeEnd(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void SetSalaryMonth_SizeChanged(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void SetSalaryMonth_Activated(object sender, EventArgs e)
        {
            this.Invalidate();
        }
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            {
                MonthlyReport.Month = tbDate.Text;
        ...
        {
            ValidateInput(tbDate, lbIsValidDate, Validator.IsValidMonth, "Invalid date format.please enter in this format (yyyy-MM)");
        }
        ...
        private void tbDate_TextChanged(object sender, EventArgs e)
        {
            ...
            if (lbIsValidDate.Text != "")
            {
                lbIsValidDate.Visible = false;
                return;
            }
        }
